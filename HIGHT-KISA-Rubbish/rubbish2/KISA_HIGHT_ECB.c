...
void HIGHT_ENC(int k, int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7, DWORD* XX, BYTE* RoundKey) {
    // DWORD temp0 = (HIGHT_F0[XX[i1]] + RoundKey[4 * k + 3]);
    // XX[i0] = (XX[i0] ^ temp0) & 0xFF;
    // DWORD temp1 = (HIGHT_F1[XX[i3]] ^ RoundKey[4 * k + 2]);
    // XX[i2] = (XX[i2] + temp1) & 0xFF;
    // DWORD temp2 = (HIGHT_F0[XX[i5]] + RoundKey[4 * k + 1]);
    // XX[i4] = (XX[i4] ^ temp2) & 0xFF;
    // DWORD temp3 = (HIGHT_F1[XX[i7]] ^ RoundKey[4 * k + 0]);
    // XX[i6] = (XX[i6] + temp3) & 0xFF;
