...
\textbf{Defining a Sequence:} In Cryptol, a sequence is defined with square brackets. Unlike C, where you typically define the array size and type, Cryptol infers these from the context.
\begin{lstlisting}[style=cryptol]
